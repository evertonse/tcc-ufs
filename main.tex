...
\begin{enumerate}
  ...
  \item Foram incluídos artigos que de alguma forma exista a criação de um compilador
  \item Foram incluídos artigos que de alguma forma sintetize uma arvóre como representação de BRDFs
\end{enumerate}
...
% \begin{table}[htb]
% \ABNTEXfontereduzida
% \caption[bases]{Resultados após análise}
% \label{tab-bases}
% \begin{tabular}{p{2.6cm}|p{6.0cm}|p{2.25cm}|p{3.40cm}}
%    %\hline
%    \textbf{Bases}
