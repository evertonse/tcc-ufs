...
This grammar defines rules for expressions, assignments, function calls and various operators such as postfix, prefix and infix. 
...
A tabela de símbolos será utilizada durante a fase de geração de código para garantir a tradução adequada do código-fonte em shaders GLSL.

\section{Padrão de Visitante e Árvore de Sintaxe}

O padrão de visitante foi empregado para percorrer e operar em uma árvore de sintaxe abstrata (AST). A estrutura da AST é definida com vários tipos de nó para capturar diferentes elementos da sintaxe da linguagem.
