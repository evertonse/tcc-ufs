...
Em \autoref{conceitos}, descrevemos por todos os conhecimentos necessário para entender BRDFs,incluingo quantificação de luminosidade, e radiação, assim como conceitos de compiladores como tokenização e construção da árvore sintática.
...
\autoref{shading} aborda o processo de shading em gráficos por computador e o funcionamento do pipeline de renderização da GPU, destacando o papel dos shaders. Descreve a transformação de vértices e a determinação da cor dos fragmentos, mostrando exemplos de código. 
