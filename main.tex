...
\begin{figure}[H]
	...
	\end{center}
	\legend{ \footnotesize O angulo de saída é identico ao angulo de entrada em relação à normal da superficie.
  Em vermelho está o raio indicente, e em azul o raio de saída.
  Fonte: Autor}
\end{figure}
