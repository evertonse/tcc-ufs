...
Também foram analisados repositórios no github e SourceForge, cada um com uma string de busca especifica. Os repositórios encontrados, foram filtrados baseados em seus resumos. Se não houver a menção da criação de um compilador, ou não citar uma transformação de uma BRDF para outra estrutura, esse repositório foi excluido.
