...
This GLSL function computes the value of the quadratic equation \( f(x) \) given the coefficients \( a \), \( b \), and \( c \), and the input variable \( x \).
