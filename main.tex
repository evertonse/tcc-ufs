...
\begin{table}[H]
\ABNTEXfontereduzida
  \caption[bases]{Resultados das bases após aplicar os critérios.}
\label{tab-result}
...
\begin{codigo}[H]
\caption{Código GLSL da função quadrática g.}
\label{cod-glsl-g}
\begin{lstlisting}
