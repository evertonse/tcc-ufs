...
\index{tabelas}A \autoref{tab-nivinv} ├⌐ um exemplo de tabela constru├¡da em
\LaTeX.

\begin{table}[htb]
\ABNTEXfontereduzida
\caption[N├¡veis de investiga├º├úo]{N├¡veis de investiga├º├úo.}
\label{tab-nivinv}
\begin{tabular}{p{2.6cm}|p{6.0cm}|p{2.25cm}|p{3.40cm}}
  %\hline
   \textbf{N├¡vel de Investiga├º├úo} & \textbf{Insumos}  & \textbf{Sistemas de Investiga├º├úo}  & \textbf{Produtos}  \\
    \hline
    Meta-n├¡vel & Filosofia\index{filosofia} da Ci├¬ncia  & Epistemologia &
    Paradigma  \\
    \hline
    N├¡vel do objeto & Paradigmas do metan├¡vel e evid├¬ncias do n├¡vel inferior &
    Ci├¬ncia  & Teorias e modelos \\
    \hline
    N├¡vel inferior & Modelos e m├⌐todos do n├¡vel do objeto e problemas do n├¡vel inferior & Pr├ítica & Solu├º├úo de problemas  \\
   % \hline
\end{tabular}
\legend{Fonte: \citeonline{van86}}
\end{table}

J├í a \autoref{tabela-ibge} apresenta uma tabela criada conforme o padr├úo do
\citeonline{ibge1993} requerido pelas normas da ABNT para documentos t├⌐cnicos e
acad├¬micos.

\begin{table}[htb]
\IBGEtab{%
  \caption{Um Exemplo de tabela alinhada que pode ser longa
  ou curta, conforme padr├úo IBGE.}%
  \label{tabela-ibge}
}{%
  \begin{tabular}{ccc}
  \toprule
  ...
  \midrule 
   Jo├úo Souza & 11/11/2111 & 211.111.111-11 \\
  \midrule 
   Laura Vicu├▒a & 05/04/1891 & 3111.111.111-11 \\
  \bottomrule
\end{tabular}%
}{%
  \fonte{Produzido pelos autores.}%
  \nota{Esta ├⌐ uma nota, que diz que os dados s├úo baseados na
  regress├úo linear.}%
  \nota[Anota├º├╡es]{Uma anota├º├úo adicional, que pode ser seguida de v├írias
  outras.}%
  }
\end{table}
