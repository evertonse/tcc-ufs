...
Para formalizar a gramática da linguagem de entrada (\texttt{SimpleLang}) deste compilador, definimos suas regras no \autoref{lst-gramatica}. Um exemplo de código fonte válido em \texttt{SimpleLang}, de acordo com essa gramática, é apresentado em \autoref{code-gramatica}.
