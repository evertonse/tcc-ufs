...
\begin{enumerate}
    ...
    \item Suporta o produto vetorial (\verb|cross|). Nesse caso, o operador vem primeiro, no lugar de infixo: \verb|\vec{n_1}| \verb"\cross" \verb"\vec{n_2}" é \\ equivalente a \verb|cross(vec3(var_1_n_1), vec3(var_2_n_2))|.
