...
\lstdefinestyle{baseStyle}{
    ...
    extendedchars=true,
    % morekeywords={begin,\\begin},
    % morekeywords=[2]{begin, \begin,\\begin},
}


% https://tex.stackexchange.com/questions/28229/extend-a-language-with-additional-keywords
% \lstdefinestyle{tex}{
%     language=TeX,
%     style=baseStyle,
%     morekeywords={begin,end, \begin},
% }
%
% \lstnewenvironment{tex}[1][]{\lstset{style=tex, #1}}{}

% \lstnewenvironment{tex}[1][]{\lstset{style=pythonStyle, #1}}{}
...
\lstdefinestyle{cStyle}{
    ...
    morekeywords={include,define,void,int,char,float,double,long,unsigned,
                  ...
                  case,break,continue,default,goto, vec3},
