...
As equações que descrevem esse experimento se encontram em \autoref{fig-blinn-phong-eqlang-latex}. O código fonte de entrada para o compilador está dividido em duas partes, parte 1 está no \autoref{cod-blinn-phong-eqlang} e a segunda parte está em \autoref{cod-blinn-phong-eqlang-pt2}. A renderização dos objetos 3D usando essa BRDF se encontra em \autoref{fig-blinn-phong-eqlang}.
...
\begin{figure}[H]
    \caption{\small{Distribuição de Reflexão Especular e Difusa da BRDF}}\label{fig-blinn-phong-eqlang}
...
\begin{codigo}[H]
    ...
    \label{cod-blinn-phong-eqlang-declarations}
